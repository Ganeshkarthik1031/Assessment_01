...
const DashboardPage = () => {
  const tableData = React.useRef([
    {
      productname: "images/img_unsplashwh2fhl0veo.png",
      text: "text",
      stock: "32 in stock",
      price: "$ 45.99",
      totalsales: "20",
    ...
    {
      productname: "images/img_unsplasha2jnamzag.png",
      text: "text",
      stock: "32 in stock",
      price: "$ 45.99",
      totalsales: "20",
    ...
    {
      productname: "images/img_unsplashrazur66vuc.png",
      text: "text",
      stock: "32 in stock",
      price: "$ 45.99",
      totalsales: "20",
    ...
    {
      productname: "images/img_unsplashcpccybprfa.png",
      text: "text",
      stock: "32 in stock",
      price: "$ 45.99",
      totalsales: "20",
      ...
      tableColumnHelper.accessor("productname", {
        cell: (info) => (
          <div className="flex flex-row items-center justify-start p-0.5">
            ...
            />
            <p style={{ fontWeight: 'bold' }}>Abstract 3D.</p>
            <p style={{ fontSize: '10px' }}>This is a paragraph with a custom font size.</p>
          </div>
        ),
        header: (info) => (
          <Text
    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-start justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-10 gap-[71px] items-start justify-start md:px-5 w-[94%] md:w-full">
          <Sidebar1 className="!sticky !w-[306px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto shadow-bs1 top-[0]" />
          <div className="flex flex-1 flex-col items-center justify-start w-full">
            ...
            <div className="bg-white-A700 flex flex-col items-center justify-start mt-[23px] p-[31px] sm:px-5 rounded-[30px] shadow-bs1 w-full">
              <List
                className="sm:flex-col flex-row gap-[40.5px] grid sm:grid-cols-[repeat(0,_1fr_1px)_1fr] md:grid-cols-[repeat(1,_1fr_1px)_1fr] grid-cols-[repeat(2,_1fr_1px)_1fr] justify-center mb-0.5 pb-0.5 w-[93%]"
                orientation="horizontal"
              >
                <Dashboard className="flex flex-col items-center justify-start w-full" />
                  ...
                  <div className="flex flex-row gap-5 items-center justify-between w-full">
                    <div className="bg-gradient1  flex flex-col h-[84px] items-center justify-end p-5 rounded-[50%] w-[84px]">
                      <Img
                        ...
                        src="images/img_walletmoney1.svg"
                        alt="walletmoneyOne"
                      />
                    </div>
